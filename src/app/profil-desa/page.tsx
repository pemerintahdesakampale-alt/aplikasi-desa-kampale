...
const menuItems = [
  { title: 'Profil Desa', component: <ProfilDesa />, color: "linear-gradient(90deg, #065f46, #0da75a)", icon: '🏠' },
  { title: 'Pemerintahan', component: <Pemerintahan />, color: "linear-gradient(90deg, #065f46, #0da75a)", icon: '🏛️' },
  { title: 'Data Desa', component: <DataDesa />, color: "linear-gradient(90deg, #065f46, #0da75a)", icon: '📊' },
  { title: 'Peta', component: <PetaDesa />, color: "linear-gradient(90deg, #065f46, #0da75a)", icon: '🗺️' },
  { title: 'Prestasi Instansi', component: <PrestasiInstansi />, color: "linear-gradient(90deg, #065f46, #0da75a)", icon: '🏆' },
  { title: 'Inovasi Desa', component: <InovasiDesa />, color: "linear-gradient(90deg, #065f46, #0da75a)", icon: '💡' },
  { title: 'SDGS', component: <SDGS />, color: "linear-gradient(90deg, #065f46, #0da75a)", icon: '🌱' },
  { title: 'IDM', component: <IDM />, color: "linear-gradient(90deg, #065f46, #0da75a)", icon: '📅' },
];
