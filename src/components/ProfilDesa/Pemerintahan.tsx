...
const ProfilDesa = () => {
  ...
  const { title, color, content, image, width, height } = slides[currentSlide];
  ...
  return (
    ...
    >
      ...
      {image && (
        <div style={{ position: 'relative', width: '100%', height: height * (620 / width) }}>
          <Image
            src={image}
            alt={title}
            width={width}
            ...
            priority // opsional: jika ini gambar penting di atas fold
          />
        </div>
      )}
